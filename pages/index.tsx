...
export default function Home() {
  ...
  const inputClass =
    'block w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-900 placeholder-slate-400 outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/30';
  ...
  const jsonLd = {
    ...
    address: {
      '@type': 'PostalAddress',
      streetAddress: '555 W Airport Fwy, Suite 106',
      addressLocality: 'Irving',
      addressRegion: 'TX',
      postalCode: '75062',
      addressCountry: 'US',
    },
    areaServed: ['Irving, TX', 'Dallas, TX', 'Fort Worth, TX'],
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <a
                  href={encodeURI('https://www.google.com/maps/search/?api=1&query=555 W Airport Fwy Suite 106, Irving, TX 75062')}
                  target="_blank"
        ...
        {/* HERO sin imagen de fondo para evitar bloqueos */}
          ...
          <div className="grid items-start gap-10 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-md md:p-6">
                ...
                <form onSubmit={onSubmit} className="mt-4 grid grid-cols-1 gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 font-semibold text-white shadow-sm transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-70"
                  >
            ...
            <div className="order-2 md:order-1">
              <h1 className="text-3xl font-bold leading-tight text-slate-900 md:text-5xl">
                Seguros bien cotizados en <span className="text-indigo-600">Irving</span>.
                <br />
                Metroplex: Dallas — Fort Worth.
              </h1>
              <p className="mt-4 text-slate-600 md:text-lg">
                Somos franquicia de Del Toro Insurance en Irving. Déjanos tus datos y te contactamos
                para ofrecer opciones claras y adecuadas en auto, comercial, transporte y más.
              </p>
              <ul className="mt-6 grid gap-2 text-sm text-slate-700 sm:grid-cols-2">
                ...
                <li className="rounded-full border border-slate-200 bg-white px-3 py-2">Opciones a medida</li>
                <li className="rounded-full border border-slate-200 bg-white px-3 py-2">Asesoría en español</li>
          ...
          <div className="no-scrollbar mt-3 overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none]">
            <div className="flex gap-3 snap-x snap-mandatory">
              {categories.map((c) => (
                <div
                  key={c}
                  className="snap-start shrink-0 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-medium text-slate-800 shadow-sm hover:border-indigo-300"
                >
                  {c}
                </div>
              ))}
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 grid gap-4 md:grid-cols-2">
              <div>
                ...
                <a href="tel:+14692101711" className="mt-1 inline-block text-base font-semibold text-indigo-700 hover:text-indigo-800">
                  (469) 210-1711
                </a>
              </div>
              <div>
                ...
                <a
                  className="mt-1 inline-block text-base font-semibold text-indigo-700 hover:text-indigo-800"
                  href={encodeURI('https://www.google.com/maps/search/?api=1&query=555 W Airport Fwy Suite 106, Irving, TX 75062')}
                  target="_blank"
                  rel="noreferrer noopener"
                >
      ...
      {/* Oculta la barra de scroll horizontal en navegadores WebKit */}
      <style jsx global>{`
